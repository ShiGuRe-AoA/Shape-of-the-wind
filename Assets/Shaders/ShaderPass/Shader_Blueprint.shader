    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 Frag(Varyings i) : SV_Target
            {
                ...
                finalColor = saturate(LerpOKLab(saturate(finalColor), saturate(_HatchColor.rgb), hatchMask));
                finalColor = saturate(LerpOKLab(saturate(finalColor), saturate(_EdgeColor.rgb), edgeMask));
                finalColor = saturate(LerpOKLab(saturate(finalColor), saturate(_HighlightLineColor.rgb), highlightMaskLine));
